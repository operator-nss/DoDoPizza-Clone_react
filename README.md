# React Пицца. Клон сайта широко известной пиццерии

Ссылка на сайт(https://react-pizza.bizsokolov.ru/)

## Особенности:
- **Улучшенный функционал по сравнению с оригинальным сайтом известной пиццерии**
- **Fetching данных с сервера(картинки, ингридиенты и тд)**
- **В корзине при нажатии на кнопку оформить заказ => заказ отправляется на сервер и отображается в "мои заказы"**
